...
//  ласс дл€ сектора, на которые будет разбито игровое пространство
struct Sector {
    size_t id{};
...
struct PhysicsEngine {
    ...
    /*
    * ќбработка коллизий между шарами происходит следующим образом:
    * ¬ цел€х производительности всЄ игровое пространство было разделено на секции, 
    * шар может приинадлежать нескольким секци€м. ѕроверка на наличие коллизий происходит только между шарами
    * в одной секции. Ёто позволило увеличить производительность за счЄт того, что не надо сравнивать шары
    * наход€щиес€ далеко друг от друга. јсимптотическа€ сложность такого решени€: O( (n^2)/k )
    */

    // ¬ цел€х увеличени€ производительности можно написать свой класс ThreadPool
    ...
    void ballsCollisionResponse(Ball& lhs, Ball& rhs) {
        ...
        // –ассчитываем новое направление после столкновени€
    ...
    void ballWallCollision(Ball& ball, const Wall& wall) {
        ...
        if (distance <= ball.r) {
            ...
            // ќсвобождаем шар, застр€вший в стене
            ...
            // –ассчитываем новое направление движени€
